...
return [
    ...
    'grammar' => [
        ...
        16 => new \Phplrt\Parser\Grammar\Concatenation([209, 210]),
        ...
        49 => new \Phplrt\Parser\Grammar\Alternation([211, 212, 213, 214, 215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 228, 229]),
        ...
        104 => new \Phplrt\Parser\Grammar\Alternation(['OptionDecl', 'OneofField']),
        ...
        122 => new \Phplrt\Parser\Grammar\Optional(60),
        ...
        133 => new \Phplrt\Parser\Grammar\Concatenation([204, 205]),
        ...
        143 => new \Phplrt\Parser\Grammar\Repetition('Comment', 0, INF),
        144 => new \Phplrt\Parser\Grammar\Lexeme('T_ENUM', false),
        ...
        152 => new \Phplrt\Parser\Grammar\Optional(60),
        153 => new \Phplrt\Parser\Grammar\Lexeme('T_SEMICOLON', false),
        154 => new \Phplrt\Parser\Grammar\Optional('InlineComment'),
        155 => new \Phplrt\Parser\Grammar\Alternation(['OptionDecl', 'RpcDecl']),
        156 => new \Phplrt\Parser\Grammar\Lexeme('T_SEMICOLON', false),
        157 => new \Phplrt\Parser\Grammar\Repetition('Comment', 0, INF),
        158 => new \Phplrt\Parser\Grammar\Lexeme('T_SERVICE', false),
        159 => new \Phplrt\Parser\Grammar\Lexeme('T_IDENTIFIER', true),
        160 => new \Phplrt\Parser\Grammar\Lexeme('T_LBRACE', false),
        161 => new \Phplrt\Parser\Grammar\Repetition(155, 0, INF),
        162 => new \Phplrt\Parser\Grammar\Lexeme('T_RBRACE', false),
        163 => new \Phplrt\Parser\Grammar\Optional(156),
        164 => new \Phplrt\Parser\Grammar\Lexeme('T_LBRACE', false),
        165 => new \Phplrt\Parser\Grammar\Repetition('OptionDecl', 0, INF),
        166 => new \Phplrt\Parser\Grammar\Lexeme('T_RBRACE', false),
        167 => new \Phplrt\Parser\Grammar\Concatenation([164, 165, 166]),
        168 => new \Phplrt\Parser\Grammar\Lexeme('T_SEMICOLON', false),
        169 => new \Phplrt\Parser\Grammar\Repetition('Comment', 0, INF),
        170 => new \Phplrt\Parser\Grammar\Lexeme('T_RPC', false),
        171 => new \Phplrt\Parser\Grammar\Lexeme('T_IDENTIFIER', true),
        172 => new \Phplrt\Parser\Grammar\Lexeme('T_LPAREN', false),
        173 => new \Phplrt\Parser\Grammar\Lexeme('T_RPAREN', false),
        174 => new \Phplrt\Parser\Grammar\Lexeme('T_RETURNS', false),
        175 => new \Phplrt\Parser\Grammar\Lexeme('T_LPAREN', false),
        176 => new \Phplrt\Parser\Grammar\Lexeme('T_RPAREN', false),
        177 => new \Phplrt\Parser\Grammar\Alternation([167, 168]),
        178 => new \Phplrt\Parser\Grammar\Lexeme('T_STREAM', true),
        179 => new \Phplrt\Parser\Grammar\Lexeme('T_DOT', false),
        180 => new \Phplrt\Parser\Grammar\Lexeme('T_DOT', false),
        181 => new \Phplrt\Parser\Grammar\Concatenation([180, 71]),
        182 => new \Phplrt\Parser\Grammar\Optional(178),
        183 => new \Phplrt\Parser\Grammar\Optional(179),
        184 => new \Phplrt\Parser\Grammar\Repetition(181, 0, INF),
        185 => new \Phplrt\Parser\Grammar\Lexeme('T_DOUBLE', false),
        186 => new \Phplrt\Parser\Grammar\Lexeme('T_FLOAT', false),
        187 => new \Phplrt\Parser\Grammar\Lexeme('T_INT32', false),
        188 => new \Phplrt\Parser\Grammar\Lexeme('T_INT64', false),
        189 => new \Phplrt\Parser\Grammar\Lexeme('T_UINT32', false),
        190 => new \Phplrt\Parser\Grammar\Lexeme('T_UINT64', false),
        191 => new \Phplrt\Parser\Grammar\Lexeme('T_SINT32', false),
        192 => new \Phplrt\Parser\Grammar\Lexeme('T_SINT64', false),
        193 => new \Phplrt\Parser\Grammar\Lexeme('T_FIXED32', false),
        194 => new \Phplrt\Parser\Grammar\Lexeme('T_FIXED64', false),
        195 => new \Phplrt\Parser\Grammar\Lexeme('T_SFIXED32', false),
        196 => new \Phplrt\Parser\Grammar\Lexeme('T_SFIXED64', false),
        197 => new \Phplrt\Parser\Grammar\Lexeme('T_BOOL', false),
        198 => new \Phplrt\Parser\Grammar\Lexeme('T_STRING', false),
        199 => new \Phplrt\Parser\Grammar\Lexeme('T_BYTES', false),
        200 => new \Phplrt\Parser\Grammar\Lexeme('T_INLINE_COMMENT', true),
        201 => new \Phplrt\Parser\Grammar\Lexeme('T_BLOCK_COMMENT', true),
        202 => new \Phplrt\Parser\Grammar\Lexeme('T_MAX', true),
        203 => new \Phplrt\Parser\Grammar\Lexeme('T_INT_LITERAL', true),
        204 => new \Phplrt\Parser\Grammar\Lexeme('T_TO', false),
        205 => new \Phplrt\Parser\Grammar\Alternation([202, 203]),
        206 => new \Phplrt\Parser\Grammar\Lexeme('T_DOT', true),
        207 => new \Phplrt\Parser\Grammar\Lexeme('T_IDENTIFIER', true),
        208 => new \Phplrt\Parser\Grammar\Concatenation([206, 207]),
        209 => new \Phplrt\Parser\Grammar\Lexeme('T_IDENTIFIER', true),
        210 => new \Phplrt\Parser\Grammar\Repetition(208, 0, INF),
        211 => new \Phplrt\Parser\Grammar\Lexeme('T_IDENTIFIER', true),
        212 => new \Phplrt\Parser\Grammar\Lexeme('T_MESSAGE', false),
        213 => new \Phplrt\Parser\Grammar\Lexeme('T_ENUM', false),
        214 => new \Phplrt\Parser\Grammar\Lexeme('T_ONEOF', false),
        215 => new \Phplrt\Parser\Grammar\Lexeme('T_MAP', false),
        216 => new \Phplrt\Parser\Grammar\Lexeme('T_RESERVED', false),
        217 => new \Phplrt\Parser\Grammar\Lexeme('T_SYNTAX', false),
        218 => new \Phplrt\Parser\Grammar\Lexeme('T_PACKAGE', false),
        219 => new \Phplrt\Parser\Grammar\Lexeme('T_IMPORT', false),
        220 => new \Phplrt\Parser\Grammar\Lexeme('T_SERVICE', false),
        221 => new \Phplrt\Parser\Grammar\Lexeme('T_RPC', false),
        222 => new \Phplrt\Parser\Grammar\Lexeme('T_RETURNS', false),
        223 => new \Phplrt\Parser\Grammar\Lexeme('T_STREAM', false),
        224 => new \Phplrt\Parser\Grammar\Lexeme('T_REPEATED', false),
        225 => new \Phplrt\Parser\Grammar\Lexeme('T_OPTIONAL', false),
        226 => new \Phplrt\Parser\Grammar\Lexeme('T_OPTION', false),
        227 => new \Phplrt\Parser\Grammar\Lexeme('T_REQUIRED', false),
        228 => new \Phplrt\Parser\Grammar\Lexeme('T_WEAK', false),
        229 => new \Phplrt\Parser\Grammar\Lexeme('T_PUBLIC', false),
        'BuiltInType' => new \Phplrt\Parser\Grammar\Alternation([185, 186, 187, 188, 189, 190, 191, 192, 193, 194, 195, 196, 197, 198, 199]),
        'Comment' => new \Phplrt\Parser\Grammar\Alternation([200, 201]),
        'EnumDef' => new \Phplrt\Parser\Grammar\Concatenation([143, 144, 49, 145, 146, 147, 148]),
        'EnumField' => new \Phplrt\Parser\Grammar\Concatenation([149, 150, 151, 152, 153, 154]),
        ...
        'MapFieldDecl' => new \Phplrt\Parser\Grammar\Concatenation([114, 115, 116, 59, 117, 59, 118, 119, 120, 121, 122, 123]),
        'MessageDef' => new \Phplrt\Parser\Grammar\Concatenation([52, 53, 49, 54, 55, 56, 57]),
        'MessageType' => new \Phplrt\Parser\Grammar\Concatenation([182, 183, 71, 184]),
        'OneofDecl' => new \Phplrt\Parser\Grammar\Concatenation([105, 106, 49, 107, 108, 109]),
        'OneofField' => new \Phplrt\Parser\Grammar\Concatenation([59, 49, 110, 111, 112, 113]),
        ...
        'RpcDecl' => new \Phplrt\Parser\Grammar\Concatenation([169, 170, 171, 172, 'MessageType', 173, 174, 175, 'MessageType', 176, 177]),
        'ServiceDef' => new \Phplrt\Parser\Grammar\Concatenation([157, 158, 159, 160, 161, 162, 163]),
